...
Widget viewClaymoreWeapons({required int index, required var context}) {
  var weaData = WeaponData.data;
  return Column(
    children: [
      for(int i = 0; i < index; i++)
        if(weaData[i].type.toString() == 'Type.CLAYMORE')
          Card(
            child: InkWell(
              onTap: () {
                ...
                children: [
                  Stack(
                    children: [
                      ...
                      Image.asset('assets/images/weapons/claymore/${weaData[i].slug}.webp', width: 100.0,),
                    ],
                  ),
                  SizedBox(width: 8.0,),
